...
class DeepSymbolicOptimizer():
    ...
    def setup(self):
        ...
        self.Ho = self.config_training.get("Ho")
        self.w1 = self.config_training["w1"]
        self.w2 = self.config_training["w2"]
        self.w3 = self.config_training["w3"]
    ...
    def make_gp_controller(self):
        if self.config_gp_meld.pop("run_gp_meld", False):
            ...
            gp_controller = GPController(self.prior,
                                         ...
                                         self.w3,
                                         **self.config_gp_meld)
        # elif self.config_gp_meld.pop("run_Ho_gp", False):
        #     from dso.gp.gp_controller import GPController
        #     gp_controller = GPController(self.prior,
        #                                  self.pool,
        #                                  **self.config_gp_meld)
