...
def main():
   ...
   new_config_json = os.path.join("../config/benchmark_regression-Z-train-4.json")

   benchmark = "Z-train-4"
   ground_truth = "div,mul,cos,1.0,div,1.0,x1,add,sub,1.0,mul,2.0,mul,cos,1.0,div,1.0,x1,div,1.0,n2,x1"
