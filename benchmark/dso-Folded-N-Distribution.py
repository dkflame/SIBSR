...
def main():
	...
	new_config_json = os.path.join("../config/benchmark_regression-Folded-N-Distribution.json")

	benchmark = "Folded-N-Distribution"
	ground_truth = "add,mul,div,1.0,2.0,mul,div,sqrt,mul,2.0,3.14159,exp,neg,div,n2,x1,2.0,mul,div,1.0,2.0,mul,div,sqrt,mul,2.0,3.14159,exp,neg,div,n2,x2,2.0"
