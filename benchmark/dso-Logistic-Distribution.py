...
def main():
	...
	new_config_json = os.path.join("../config/benchmark_regression-Logistic-Distributionn.json")

	benchmark = "Logistic-Distribution"
	ground_truth = "div,exp,neg,x1,n2,add,1.0,exp,neg,1.0"
