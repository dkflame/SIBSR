...
def main():
   ...
   new_config_json = os.path.join("../config/benchmark_regression-Entropy.json")

   benchmark = "Entropy"
   ground_truth = "sub,neg,div,mul,x1,log,x1,log,2.0,div,mul,div,1.0,x1,log,sub,1.0,x1,log,2.0"
